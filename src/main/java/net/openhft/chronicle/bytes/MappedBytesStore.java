...
public class MappedBytesStore extends NativeBytesStore<Void> {
    ...
    static class MBSBytes extends NativeBytes<Void> {
        public MBSBytes(@NotNull BytesStore store) throws IllegalStateException, IllegalArgumentException {
            super(store);
        }
